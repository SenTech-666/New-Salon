  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6">
      ...
      <div className="bg-card rounded-3xl border border-border p-6 h-fit">
        <h2 className="font-semibold text-card-foreground mb-5">Новая блокировка</h2>

        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium text-card-foreground/80 block mb-1.5">
              Мастер
            </label>
            <select
              value={masterId}
              onChange={(e) => setMasterId(e.target.value)}
              className="w-full h-11 px-3 rounded-2xl border border-border bg-background text-sm text-foreground focus:outline-none focus:border-primary"
            >
              {masters.map((m) => (
          ...
          <button
            ...
            className="w-full h-12 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium flex items-center justify-center gap-2 transition-all disabled:opacity-50"
          >
      ...
      <div className="bg-card rounded-3xl border border-border overflow-hidden h-fit">
        <div className="px-6 py-4 border-b border-border">
          <h2 className="font-semibold text-card-foreground">Активные блокировки</h2>
        </div>
            ...
            {initialBlocks.map((b) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-xl hover:bg-destructive/15 text-muted-foreground hover:text-destructive transition-all flex items-center justify-center shrink-0"
                >
