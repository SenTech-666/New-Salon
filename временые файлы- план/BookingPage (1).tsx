    ...
    <div className="min-h-screen landing-bp-bg pb-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl relative">
        ...
        <div className="landing-glass" style={{ borderRadius: 24, overflow: 'hidden' }}>
          <div className="flex flex-row items-center justify-between px-6 sm:px-10 pt-5 pb-4">
          ...
          <div className="px-3 sm:px-6 pb-6">
            <div className="grid grid-cols-7 gap-1.5 mb-3 text-center text-xs font-medium" style={{ color: 'var(--landing-text-dim)' }}>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        >
          ...
          <div className="landing-progress-track">
            <div className="landing-progress-fill" style={{ width: `${((stepIndex + 1) / stepOrder.length) * 100}%` }} />
          </div>
